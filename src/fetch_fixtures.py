...
# ยืนยันกับแพลน Pro ของ API-SPORTS แล้วว่าดึงล่วงหน้าถึงมะรืน (+2 วัน) ได้ ไม่ติด error เรื่องแพลน
# (แพลน free เดิมได้แค่ +1 วัน จึงเคยจำกัดไว้ที่ 2)
# เพิ่ม/ลดค่านี้ได้เลย ส่วนอื่น (ป้ายวัน / จำนวนครั้งที่ยิง API) คำนวณตามเอง
DAYS_AHEAD = 3
